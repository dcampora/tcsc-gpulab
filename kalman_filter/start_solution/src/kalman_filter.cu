                   ...
                   int const)
{
  ...
  /* Read names of binary files in folders hits and tracks and store them in a vector */
  ...
  /* Read the binary files with the hits and tracks 
     and store them in host_hits and host_tracks respectively 
     Also get the offsets to the beginning of every event in the hits and tracks arrays
     and store them in event_offsets_hits and event_offsets_tracks respectively
  */
