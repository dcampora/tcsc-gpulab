...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        cmake_args = ['-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=' + extdir,
                      ...
                      '-DENABLE_PYTHON=ON', '-Wno-dev']

        for env_var, cmake_var in [('CXX', 'CMAKE_CXX_COMPILER'),
                                   ('CXX_HOST', 'CMAKE_CUDA_HOST_COMPILER')]:
            if env_var in os.environ:
                cmake_args += ['-D{}={}'.format(cmake_var, os.environ[env_var])]
...
setup(
    ...
    version=__version__,
    author='Roel Aaij',
    author_email='roel.aaij@nikhef.nl',
    url='https://gitlab.nikhef.nl/roelaaij/kalman_filter',
    description='Kalman Filter exercise',
    long_description='',
